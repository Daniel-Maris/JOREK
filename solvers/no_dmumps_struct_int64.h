...
!    ----------------------------------------
         ...
         INTEGER*8, DIMENSION(:), POINTER :: IRN, JCN
...
!        ------------------------------------
         INTEGER*8 NZ_loc
         INTEGER*8, DIMENSION(:), POINTER :: IRN_loc, JCN_loc
...
!    -------------------------------------------------------
         ...
         INTEGER*8, DIMENSION(:), POINTER :: IRHS_SPARSE
         INTEGER*8, DIMENSION(:), POINTER :: IRHS_PTR
         INTEGER*8, DIMENSION(:), POINTER :: ISOL_LOC
         INTEGER*8 LRHS, NRHS, NZ_RHS, LSOL_LOC, LREDRHS
         INTEGER*8 PADDING
!    ----------------------------
!    Control parameters,
