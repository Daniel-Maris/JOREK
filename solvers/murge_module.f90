...
#  define MURGE_ASSEMBLYBEGIN_WITHOUT_N
#else
...
#  endif
  ...
  ! Backward compatibility
   SUBROUTINE MURGE_ASSEMBLYBEGIN_WRAPPER(ID, N, COEFNBR, OP, OP2, MODE, SYM, IERROR)
     INTEGER(KIND=MURGE_INTS_KIND),      INTENT(IN)  :: ID, OP, OP2, MODE, SYM, N
     INTEGER(KIND=MURGE_INTL_KIND),      INTENT(IN)  :: COEFNBR
     INTEGER(KIND=MURGE_INTS_KIND),      INTENT(OUT) :: IERROR
     IERROR=0
#ifdef USE_MURGE
#ifdef MURGE_ASSEMBLYBEGIN_WITHOUT_N
     CALL MURGE_ASSEMBLYBEGIN(ID, COEFNBR, OP, OP2, MODE, SYM, IERROR)
#else
     CALL MURGE_ASSEMBLYBEGIN(ID, N, COEFNBR, OP, OP2, MODE, SYM, IERROR)
#endif
#endif
   END SUBROUTINE MURGE_ASSEMBLYBEGIN_WRAPPER
  !>
