...
if (my_id .eq. 0) then
  ...
  call MPI_PACK (n_pf_coils_nml,        1,MPI_INTEGER,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
...
if (my_id .ne. 0) then
  ...
  call MPI_UNPACK(buffer,bufsize,position,n_pf_coils_nml,         1,MPI_INTEGER,MPI_COMM_WORLD,ierr)
