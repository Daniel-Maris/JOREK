...
if (my_id .eq. 0) then
  ...
  call MPI_PACK(fix_psi_j_u_w,          1,MPI_LOGICAL,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(set_chi_perp_const,     1,MPI_LOGICAL,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(BC_T_const_far_SOL,     1,MPI_LOGICAL,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  ...
  call MPI_PACK(use_recombination,      1,MPI_LOGICAL,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(use_puffing,            1,MPI_LOGICAL,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(use_line_radiation,     1,MPI_LOGICAL,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  ...
  call MPI_PACK(use_controller,            1,MPI_LOGICAL,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(control_t_dep_signal_file,            512,MPI_CHARACTER,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  ...
  call MPI_PACK(max_value,             1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(min_value,             1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(controller_type,            12,MPI_CHARACTER,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
...
if (my_id .ne. 0) then
  ...
  call MPI_UNPACK(buffer,bufsize,position,fix_psi_j_u_w,          1,MPI_LOGICAL,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,set_chi_perp_const,     1,MPI_LOGICAL,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,BC_T_const_far_SOL,     1,MPI_LOGICAL,MPI_COMM_WORLD,ierr)
  ...
  call MPI_UNPACK(buffer,bufsize,position,use_recombination,      1,MPI_LOGICAL,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,use_puffing,            1,MPI_LOGICAL,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,use_line_radiation,     1,MPI_LOGICAL,MPI_COMM_WORLD,ierr)
  ...
  call MPI_UNPACK(buffer,bufsize,position,use_controller,         1,MPI_LOGICAL,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,control_t_dep_signal_file,         512,MPI_CHARACTER,MPI_COMM_WORLD,ierr)
  ...
  call MPI_UNPACK(buffer,bufsize,position,max_value,              1,MPI_REAL8,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,min_value,              1,MPI_REAL8,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,controller_type,         12,MPI_CHARACTER,MPI_COMM_WORLD,ierr)
