...
!==========================Added input for SPI model===========================================
  ...
  call MPI_PACK(spi_num_file, n_inj_max*256,MPI_CHARACTER,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(spi_hdf5,                 1,MPI_INTEGER,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
...
!==========================Added input for SPI model===========================================
  ...
  call MPI_UNPACK(buffer,bufsize,position,spi_num_file, n_inj_max*256,MPI_CHARACTER,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,spi_hdf5,                 1,MPI_INTEGER,MPI_COMM_WORLD,ierr)
