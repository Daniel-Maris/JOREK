...
!==========================Added input for SPI model===========================================
  ...
  call MPI_PACK(use_manual_rng_seed,    1,MPI_LOGICAL,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(manual_rng_seed,        1,MPI_INTEGER,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
...
!==========================Added input for SPI model===========================================
  ...
  call MPI_UNPACK(buffer,bufsize,position,use_manual_rng_seed,    1,MPI_LOGICAL,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,manual_rng_seed,        1,MPI_INTEGER,MPI_COMM_WORLD,ierr)
