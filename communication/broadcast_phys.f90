...
#ifdef USE_HDF5
  bufsize = ( (350+2*max_limiter+n_var) * IDBL_EXT + (33+n_tor) * INT_EXT + 42 * ILOG_EXT + (12*512+120) * CHAR_EXT )
#else
  bufsize = ( (349+2*max_limiter+n_var) * IDBL_EXT + (32+n_tor) * INT_EXT + 41 * ILOG_EXT + (12*512+120) * CHAR_EXT )
#endif
