...
if (my_id .eq. 0) then
  ...
  call MPI_PACK(Dimp_perp_num,          1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
...
if (my_id .ne. 0) then
  ...
  call MPI_UNPACK(buffer,bufsize,position,Dimp_perp_num,          1,MPI_REAL8,MPI_COMM_WORLD,ierr)
