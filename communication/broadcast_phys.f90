...
if (my_id .eq. 0) then
  ...
  call MPI_PACK(mode_coord,            n_tor,MPI_INTEGER,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
...
if (my_id .ne. 0) then
  ...
  call MPI_UNPACK(buffer,bufsize,position,mode_coord,               n_tor,MPI_INTEGER,MPI_COMM_WORLD,ierr)
