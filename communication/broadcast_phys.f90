...
if (my_id .eq. 0) then
  ...
  call MPI_PACK(Dn_perp_sc_num,         1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(Dn_par_sc_num,          1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
...
if (my_id .ne. 0) then
  ...
  call MPI_UNPACK(buffer,bufsize,position,Dn_perp_sc_num,         1,MPI_REAL8,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,Dn_par_sc_num,          1,MPI_REAL8,MPI_COMM_WORLD,ierr)
