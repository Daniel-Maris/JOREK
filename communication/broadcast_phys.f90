...
!===============================End of SPI model===============================================
  ...
  call MPI_PACK(parallel_projection,    1,MPI_LOGICAL,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
...
if (my_id .ne. 0) then
  ...
  call MPI_UNPACK(buffer,bufsize,position,ns_Z,                  10,MPI_REAL8,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,ns_phi,                10,MPI_REAL8,MPI_COMM_WORLD,ierr)
...
!===============================End of SPI model===============================================
  ...
  call MPI_UNPACK(buffer,bufsize,position,parallel_projection,    1,MPI_LOGICAL,MPI_COMM_WORLD,ierr)
