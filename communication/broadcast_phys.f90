...
if (my_id .eq. 0) then
  ...
  call MPI_PACK(K_i_par,                1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(ZK_e_perp,             10,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(K_e_par,                1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  ...
  call MPI_PACK (n_polcoils_nml,        1,MPI_INTEGER,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  
  call MPI_PACK (polcoils0%current,       30,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK (polcoils0%FB_amp,        30,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK (polcoils0%pert,          30,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  ...
  call MPI_PACK(murge_cuda_nbr,         1,MPI_INTEGER,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  ...
  call MPI_PACK(impose_coil_currents,   1,MPI_LOGICAL,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  ...
  call MPI_PACK(murge_with_starpu,      1,MPI_LOGICAL,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
...
if (my_id .ne. 0) then
  ...
  call MPI_UNPACK(buffer,bufsize,position,n_polcoils_nml,            1,MPI_INTEGER,MPI_COMM_WORLD,ierr)
  
  call MPI_UNPACK(buffer,bufsize,position,polcoils0%current,        30,MPI_REAL8,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,polcoils0%FB_amp,         30,MPI_REAL8,MPI_COMM_WORLD,ierr) 
  call MPI_UNPACK(buffer,bufsize,position,polcoils0%pert,           30,MPI_REAL8,MPI_COMM_WORLD,ierr) 
  ...
  call MPI_UNPACK(buffer,bufsize,position,murge_cuda_nbr,         1,MPI_INTEGER,MPI_COMM_WORLD,ierr)
  ...
  call MPI_UNPACK(buffer,bufsize,position,impose_coil_currents,   1,MPI_LOGICAL,MPI_COMM_WORLD,ierr)
  ...
  call MPI_UNPACK(buffer,bufsize,position,murge_with_starpu,      1,MPI_LOGICAL,MPI_COMM_WORLD,ierr)
