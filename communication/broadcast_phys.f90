...
!==========================Added input for SPI model===========================================
  ...
  call MPI_PACK(xr_closed,              2,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  ...
  call MPI_PACK(modify_meshac,          1,MPI_LOGICAL,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
...
!==========================Added input for SPI model===========================================
  ...
  call MPI_UNPACK(buffer,bufsize,position,xr_closed,		  2,MPI_REAL8,MPI_COMM_WORLD,ierr)
  ...
  call MPI_UNPACK(buffer,bufsize,position,modify_meshac,          1,MPI_LOGICAL,MPI_COMM_WORLD,ierr)
