...
if (my_id .eq. 0) then
  ...
  call MPI_PACK(a_VFB,                       3,    MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr) 
  call MPI_PACK(start_VFB_ts,                1,    MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr) 
  call MPI_PACK(VFB_tact,                    1,    MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr) 
...
if (my_id .ne. 0) then
  ...
  call MPI_UNPACK(buffer,bufsize,position,a_VFB,                  3,    MPI_REAL8,MPI_COMM_WORLD,ierr) 
  call MPI_UNPACK(buffer,bufsize,position,VFB_tact,               1,    MPI_REAL8,MPI_COMM_WORLD,ierr) 
