...
if (my_id .eq. 0) then
  ...
  call MPI_PACK(tstep,                  1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)      ! 4
  call MPI_PACK(tstep_n,               10,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)   ! 14
  call MPI_PACK(F0,                     1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)         ! 15
  call MPI_PACK(GAMMA,                  1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)      ! 16
  call MPI_PACK(Q_bar,                  1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)      ! 17
  call MPI_PACK(sigma,                  1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)      ! 18
   
  call MPI_PACK(zjz_0,                  1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)      ! 19
  call MPI_PACK(zjz_1,                  1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)      ! 20
  call MPI_PACK(zj_coef,               10,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)   ! 30

  call MPI_PACK(T_0,                    1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)        ! 31
  call MPI_PACK(T_1,                    1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)        ! 32
  call MPI_PACK(T_coef,                10,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)    ! 42

  call MPI_PACK(Ti_0,                   1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)       ! 43
  call MPI_PACK(Ti_1,                   1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)       ! 44
  call MPI_PACK(Ti_coef,               10,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)   ! 54

  call MPI_PACK(Te_0,                   1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)       ! 55
  call MPI_PACK(Te_1,                   1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)       ! 56
  call MPI_PACK(Te_coef,               10,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)   ! 66

  call MPI_PACK(rho_0,                  1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)      ! 67
  call MPI_PACK(rho_1,                  1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)      ! 68
  call MPI_PACK(rho_coef,              10,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)  ! 78

  call MPI_PACK(FF_0,                   1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)       ! 79
  call MPI_PACK(FF_1,                   1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)       ! 80
  call MPI_PACK(FF_coef,               10,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)   ! 90

  call MPI_PACK(heatsource,             1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)   ! 91
  call MPI_PACK(heatsource_i,           1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr) ! 92
  call MPI_PACK(heatsource_e,           1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr) ! 93
  call MPI_PACK(particlesource,         1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr) ! 94
  
  call MPI_PACK(ZK_perp,               10,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)    ! 104
  call MPI_PACK(ZK_par,                 1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)      ! 105
  call MPI_PACK(ZK_i_perp,             10,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)  ! 115
  call MPI_PACK(K_i_par,                1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)     ! 116
  call MPI_PACK(ZK_e_perp,             10,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)  ! 126
  call MPI_PACK(K_e_par,                1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)     ! 127
  call MPI_PACK(D_perp,                10,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)     ! 137
  call MPI_PACK(D_par,                  1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)       ! 138
  call MPI_PACK(D_neutral,              1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)   ! 139
  
  call MPI_PACK(eta,                    1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)        ! 1
  call MPI_PACK(visco,                  1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)      ! 2
  call MPI_PACK(visco_par,              1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)  ! 3
  ...
  call MPI_PACK(tauIC,                  1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)              ! 140
  call MPI_PACK(gamma_sheath,           1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)       ! 141
  call MPI_PACK(density_reflection,     1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr) ! 142
  call MPI_PACK(central_density,        1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)    ! 143

  call MPI_PACK(pellet_amplitude,       1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)   ! 148
  call MPI_PACK(pellet_R,               1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)           ! 149
  call MPI_PACK(pellet_Z,               1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)           ! 150
  call MPI_PACK(pellet_phi,             1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)         ! 151
  call MPI_PACK(pellet_radius,          1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)      ! 152
  call MPI_PACK(pellet_sig,             1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)         ! 153
  call MPI_PACK(pellet_length,          1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)      ! 154
  call MPI_PACK(pellet_psi,             1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)         ! 155
  call MPI_PACK(pellet_delta_psi,       1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)   ! 156
  call MPI_PACK(pellet_velocity_R,      1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)  ! 157
  call MPI_PACK(pellet_velocity_Z,      1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)  ! 158
  call MPI_PACK(pellet_density,         1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)     ! 159
  call MPI_PACK(pellet_particles,       1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)   ! 160
  
  call MPI_PACK(particlesource_psin,    1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)! 161
  call MPI_PACK(particlesource_sig,     1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr) ! 162
  call MPI_PACK(heatsource_psin,        1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)    ! 163
  call MPI_PACK(heatsource_sig,         1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)     ! 164_R

  call MPI_PACK(rhon_0,                 1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr) !165
  call MPI_PACK(rhon_1,                 1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr) !166
  call MPI_PACK(rhon_coef,             10,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr) !176
  
  call MPI_PACK(D_neutral_x,            1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr) !177
  call MPI_PACK(D_neutral_y,            1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr) !178
  call MPI_PACK(D_neutral_p,            1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr) !179
  
  call MPI_PACK(ksi_ion,                1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr) !180
  
  
  call MPI_PACK(mgi_amplitude,          1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr) !181
  call MPI_PACK(mgi_R,                  1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr) !182
  call MPI_PACK(mgi_Z,                  1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr) !183
  call MPI_PACK(mgi_phi,                1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr) !184
  call MPI_PACK(mgi_radius,             1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr) !185
  call MPI_PACK(mgi_sig,                1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr) !186
  call MPI_PACK(mgi_length,             1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr) !187
  
  call MPI_PACK(n_zero,                 1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr) !188
  
  call MPI_PACK(psi_axis_init,          1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr) !189
  call MPI_PACK(XR_r(:),                2,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr) !191
  call MPI_PACK(SIG_r(:),               2,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr) !193
  call MPI_PACK(XR_tht(:),              2,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr) !195
  call MPI_PACK(SIG_tht(:),             2,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr) !197
  
  call MPI_PACK(SIG_closed,             1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr) !198
  call MPI_PACK(SIG_open,               1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr) !199
  call MPI_PACK(SIG_outer,              1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr) !200
  call MPI_PACK(SIG_inner,              1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr) !201
  call MPI_PACK(SIG_private,            1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr) !202
  call MPI_PACK(SIG_up_priv,            1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr) !203
  call MPI_PACK(SIG_leg_0,              1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr) !204
  call MPI_PACK(SIG_leg_1,              1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr) !205
  call MPI_PACK(SIG_up_leg_0,           1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr) !206
  call MPI_PACK(SIG_up_leg_1,           1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr) !207

  call MPI_PACK(dPSI_open,              1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr) !208
  call MPI_PACK(dPSI_outer,             1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr) !209
  call MPI_PACK(dPSI_inner,             1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr) !210
  call MPI_PACK(dPSI_private,           1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr) !211
  call MPI_PACK(dPSI_up_priv,           1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr) !212
  call MPI_PACK(lambda,                 1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr) !213
  call MPI_PACK(tset,                   1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr) !214
  call MPI_PACK(RMP_start_time,         1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr) !215
  call MPI_PACK(t_start,                1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr) !216
  call MPI_PACK(R_limiter,    max_limiter,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr) 
  call MPI_PACK(Z_limiter,    max_limiter,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr) !216+2*max_limiter
!==============================MB velocity +12
  ...
  call MPI_PACK(V_coef,                10,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr) !228+2*max_limiter
!================= NEO
 ...
 call MPI_PACK (amu_neo_const,          1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr) !230+2*max_limiter
  ...
  call MPI_PACK(h5_diag_nbtime,         1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr) !229+2*max_limiter
  ...
  call MPI_PACK(Rmin_pfc,               20,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(Rmax_pfc,               20,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(Zmin_pfc,               20,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(Zmax_pfc,               20,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(current_pfc,            20,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  ...
  call MPI_PACK(nbdigits,               1,MPI_INTEGER,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
...
if (my_id .ne. 0) then
  ...
  call MPI_UNPACK(buffer,bufsize,position,K_i_par,                1,MPI_REAL8,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,ZK_e_perp,             10,MPI_REAL8,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,K_e_par,                1,MPI_REAL8,MPI_COMM_WORLD,ierr)
  ...
  call MPI_UNPACK(buffer,bufsize,position,mgi_length,             1,MPI_REAL8,MPI_COMM_WORLD,ierr)

  call MPI_UNPACK(buffer,bufsize,position,n_zero,                 1,MPI_REAL8,MPI_COMM_WORLD,ierr)
...
!========================== NEO
  ...
  call MPI_UNPACK(buffer,bufsize,position,Rmin_pfc,              20,MPI_REAL8,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,Rmax_pfc,              20,MPI_REAL8,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,Zmin_pfc,              20,MPI_REAL8,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,Zmax_pfc,              20,MPI_REAL8,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,current_pfc,           20,MPI_REAL8,MPI_COMM_WORLD,ierr)
  ...
  call MPI_UNPACK(buffer,bufsize,position,nbdigits,               1,MPI_INTEGER,MPI_COMM_WORLD,ierr)
