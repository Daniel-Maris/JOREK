...
! local variables
  ...
  call tr_allocate(t_s_eq,1,node_list%n_nodes,1,n_order+1,                              "node_list%s_eq",CAT_UNKNOWN)
  ...
  call HDF5_array2D_reading(file_id,t_s_eq, 's_eq')
  ...
  do i=1,node_list%n_nodes
    ...
    node_list%node(i)%s_eq     = t_s_eq(i,:)
  ...
  call tr_deallocate(t_s_eq,"t_s_eq",CAT_UNKNOWN)
