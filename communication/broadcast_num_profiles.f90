...
if ( num_rho ) then
  ...
  if ( my_id /= 0 ) allocate( num_rho_x(num_rho_len), num_rho_y0(num_rho_len) )
...
if ( num_T ) then
  ...
  if ( my_id /= 0 ) allocate( num_T_x(num_T_len), num_T_y0(num_T_len) )
...
if ( num_ffprime ) then
  ...
  if ( my_id /= 0 ) allocate( num_ffprime_x(num_ffprime_len), num_ffprime_y0(num_ffprime_len) )
