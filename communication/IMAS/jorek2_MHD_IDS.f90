...
program jorek2_MHD_IDS
  ...
  do i=1, n_var 
    ...
    if (variable_names(i) == 'Psi') then      
      ...
      call fill_Bezier_coefficients( ggd_scalar, node_list, var_psi, grid_ind, grid_sub_ind )
    endif
    ...
    if (variable_names(i) == 'u') then      
      ...
      call fill_Bezier_coefficients( ggd_scalar, node_list, var_u, grid_ind, grid_sub_ind )
    endif
    ...
    if (variable_names(i) == 'zj') then      
      ...
      call fill_Bezier_coefficients( ggd_scalar, node_list, var_zj, grid_ind, grid_sub_ind )
    endif
    ...
    if (variable_names(i) == 'omega') then      
      ...
      call fill_Bezier_coefficients( ggd_scalar, node_list, var_w, grid_ind, grid_sub_ind )
    endif
    ...
    if (variable_names(i) == 'rho') then      
      ...
      call fill_Bezier_coefficients( ggd_scalar, node_list, var_rho, grid_ind, grid_sub_ind )
    endif
    ...
    if (variable_names(i) == 'T') then      
      ...
      call fill_Bezier_coefficients( ggd_scalar, node_list, var_T, grid_ind, grid_sub_ind )
      ggd_scalar%coefficients = ggd_scalar%coefficients * 0.5d0
    endif
    ...
    if (variable_names(i) == 'v_par') then      
      ...
      call fill_Bezier_coefficients( ggd_scalar, node_list, var_vpar, grid_ind, grid_sub_ind )
    endif
