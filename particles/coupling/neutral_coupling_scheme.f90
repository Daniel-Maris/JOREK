!> Performs the projection and coupling loops specific to neutral particles
module neutral_coupling_scheme
...
contains
    ...
    subroutine ncs_loop(sim, jorek_feedback, rng, timesteps, n_steps, particle_start_time)
    ...
    end subroutine ncs_loop
end module neutral_coupling_scheme
