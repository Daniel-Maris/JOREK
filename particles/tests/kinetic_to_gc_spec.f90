!> This module contains some tests verifying the transformation from kinetic to GC coordinates and vice versa
module kinetic_to_gc_spec
use mod_boris
