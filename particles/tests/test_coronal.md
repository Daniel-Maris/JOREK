...
Compile jorek2_particles first. Adjust the location of libdierckx to your own
gfortran -I.. test_coronal_time.f90 ../openadas.o ../mod_coronal.o -fbounds-check -Wall -llapack ~/lib/Dierckx/libdierckx.a -o test_coronal_time
