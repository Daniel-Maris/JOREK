...
module mod_particle_types
  ...
  type, abstract :: particle_base
    ...
    real*8    :: weight  = 1.d0   !< weight (i.e. number of particles)
    integer*4 :: i_elm   = 0      !< index in element_list. Negative indices indicate lost particles on the edge of - that element. 0 indicates unused (i.e. free) particle
