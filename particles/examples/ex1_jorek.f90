...
events = [event(write_action(basename='test'),   step=1d-4), &
          ...
          event(project_to_vtk(node_list, element_list, smoothing=1d-3, basename='proj'), step=1d-5), &
