...
implicit none
private
public write_simulation_hdf5_old, read_simulation_hdf5_old, get_simulation_hdf5_time_old
...
subroutine write_simulation_hdf5_old(sim, filename)
...
end subroutine write_simulation_hdf5_old
...
subroutine read_simulation_hdf5_old(sim, filename)
...
end subroutine read_simulation_hdf5_old
...
function get_simulation_hdf5_time_old(filename) result(time)
  character*(*)      , intent(in)  :: filename
  real*8 :: time
  integer(HID_T) :: file
  integer :: hdferr
  ...
  call h5fclose_f(file,hdferr)
  call h5close_f(hdferr)
end function get_simulation_hdf5_time_old
end module mod_particle_io_old
