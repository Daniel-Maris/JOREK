...
subroutine int3d_new(my_id, node_list, element_list, bnd_node_list, bnd_elm_list, expr_list, res, units,aux_node_list)
...
!$omp   private(ife,iv,inode,element,nodes,i,j, k,in, mp, ms, mt,                              &  !aux_nodes
