...
program JOREK2_FOUR
  ...
  use nodes_elements, only: element_list, node_list, aux_node_list
  ...
  call import_restart(node_list, aux_node_list, element_list, 'jorek_restart', rst_format, ierr, .true.)   ! read restart file
