...
module mod_expression
  ...
  integer,           parameter, private :: LEN_NAME      = 14
  integer,           parameter, private :: LEN_DESCR     = 58
  ...
  subroutine init_expr()
    ...
    call add(exprs_all_int, 'int_jR_3d_tot ', '3D integral of the toroidal current density               ')
    call add(exprs_all_int, 'int_jR_3d_in  ', '3D integral of the toroidal current density (inside  LCFS)')
    call add(exprs_all_int, 'int_jR_3d_out ', '3D integral of the toroidal current density (outside LCFS)')
