...
module mod_expression
  ...
  subroutine init_expr()
    ...
    call add(exprs_all_int, 'int_jR_3d_tot', 'Integral of the toroidal current density               ')
    call add(exprs_all_int, 'int_jR_3d_in ', 'Integral of the toroidal current density (inside  LCFS)')
    call add(exprs_all_int, 'int_jR_3d_out', 'Integral of the toroidal current density (outside LCFS)')
