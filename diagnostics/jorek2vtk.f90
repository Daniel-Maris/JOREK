...
logical               :: include_bootstrap, include_psi_norm, include_electric_field, include_Jpol, cartesian
...
namelist /vtk_params/ nsub, i_tor, i_plane, without_n0_mode, SI_units, &
                      ...
                      include_bootstrap, include_psi_norm, include_electric_field, include_Jpol, cartesian
