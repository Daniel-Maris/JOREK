...
module hdf5_io_module
  ...
  subroutine HDF5_allocatable_array2D_reading(file_id,array2D,dsetname,reqdims,start)
    ...
    if(rank.eq.2) then
      ...
      write(*,*) 'Read 2D allocatable array from HDF5, rank is not 1: skip!'
    endif
    !*** Closing ***
    call H5Sclose_f(dataspace_id,error)
    call H5Dclose_f(dataset_id,error)
  ...
  subroutine HDF5_allocatable_array3D_reading(file_id,array3D,dsetname,reqdims,start)
    ...
    if(rank.eq.3) then
      ...
      write(*,*) 'Read 3D allocatable array from HDF5, rank is not 1: skip!'
    endif
    !*** Closing ***
    call H5Sclose_f(dataspace_id,error)
    call H5Dclose_f(dataset_id,error)
  ...
  subroutine HDF5_allocatable_array4D_reading(file_id,array4D,dsetname,reqdims,start)
    ...
    if(rank.eq.4) then
      ...
      write(*,*) 'Read 4D allocatable array from HDF5, rank is not 1: skip!'
    endif
    !*** Closing ***
    call H5Sclose_f(dataspace_id,error)
    call H5Dclose_f(dataset_id,error)
  ...
  subroutine HDF5_allocatable_array5D_reading(file_id,array5D,dsetname,reqdims,start)
    ...
    if(rank.eq.5) then
      ...
      write(*,*) 'Read 5D allocatable array from HDF5, rank is not 1: skip!'
    endif
    !*** Closing ***
    call H5Sclose_f(dataspace_id,error)
    call H5Dclose_f(dataset_id,error)
