...
real*8, intent(in)  :: s
real*8, intent(in)  :: t
real*8, intent(out) :: H(4,4)
real*8, intent(out) :: H_s(4,4)
real*8, intent(out) :: H_t(4,4)
real*8, intent(out) :: H_st(4,4)
real*8, intent(out) :: H_ss(4,4)
real*8, intent(out) :: H_tt(4,4)
...
return
end subroutine basisfunctions2
