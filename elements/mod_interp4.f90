...
!> This subroutine interpolates some deltas at a specific position within one element at a given position (s,t)
pure subroutine interp4_delta(node_list, element_list, i_elm, i_v, n_v, s, t, phi, P)
use data_structure
use phys_module, only: mode
use mod_basisfunctions
implicit none
