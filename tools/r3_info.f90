...
!$OMP THREADPRIVATE (lfirst1, lfirst2, flops, stamp)
  ...
  if (r3_mype.eq.r3_root) then
     write(file_name_r3,'(A)')"r3.out"//char(0)
  ...
  IF (r3_mytask .EQ. 0) THEN
    ...
    IF (ind .EQ. -1) THEN
      ...
      IF (r3_info_n .GT. r3_info_mx) THEN
        IF (r3_mype .EQ. r3_root) THEN
          DO i = 1, r3_info_n
            WRITE (*,*) i, TRIM (r3_info_name(i))
          END DO
          WRITE (*,*)
          WRITE (*,*) r3_info_mx + 1, TRIM (r3_info_name(i))
        END IF
    ...
    IF (r3_stak_n .GT. r3_stak_mx) THEN
      IF (r3_mype .EQ. r3_root) THEN
        DO i = 1, r3_stak_mx
          WRITE (*,*) i, TRIM (r3_info_name(r3_info_stak(i)))
        END DO
        WRITE (*,*)
        WRITE (*,*) r3_stak_mx + 1, TRIM (r3_info_name(ind))
      END IF
