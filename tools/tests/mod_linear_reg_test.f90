...
real*8,parameter  :: tol=1.d-16    !< tolerance for checking results
real*8,dimension(2),parameter       :: x_interval=(-1.d1,1.d2) !< x interval
...
subroutine linear_ref_exact_y_test()
  ...
  !> tests
  call assert_equals(lin_reg_coeff,line_coeff,N_coeff,tol,&
