...
!===================== Additional terms from friction terms============
                       + v * BigR * ((GAMMA - 1.)/2.) * vpar0**2 * BB2 * (r0_corr*rn0*Sion_T) * xjac * tstep * factor(6,11)&
                       + v * BigR * ((GAMMA - 1.)/2.) * vv2 * ((r0_corr*rn0*Sion_T))          * xjac * tstep * factor(6,11)&
!==============================End of friction terms=================

                       + v * (gamma-1.d0) * eta_T_ohm * (zj0 / BigR)**2.d0         * BigR  * xjac * tstep * factor(6,12) &
                       - v * BigR * r0_corr * rn0_corr * LradDrays_T                       * xjac * tstep * factor(6,13) &
                       - v * BigR * r0_corr * r0_corr  * LradDcont_T                       * xjac * tstep * factor(6,14) &
                       - v * BigR * r0_corr * frad_bg                                      * xjac * tstep * factor(6,15) &
                       ...
                       + zeta * v * r0 * delta_g(mp,6,ms,mt) * BigR                       * xjac         * factor(6,17)&
