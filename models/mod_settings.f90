...
integer, parameter :: n_tor             = 5      !< number of toroidal harmonics
integer, parameter :: n_coord_tor       = 21      !< number of toroidal harmonics in (R, Z) coordinates
integer, parameter :: l_pol_domm        = 9      !< highest poloidal mode in the Dommaschk potentials        
...
integer, parameter :: n_plane           = 40      !< number of toroidal angles
