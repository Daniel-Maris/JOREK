...
real*8     :: D_prof, D_prof_par, ZK_i_prof, ZK_e_prof, psi_norm, theta, zeta, delta_u_x, delta_u_y, delta_ps_x, delta_ps_y
...
!###################################################################################################
         ...
         rhs_ij_5   = v * BigR * (particle_source(ms,mt) + source_pellet+source_bg+source_imp) * xjac * tstep &
                    ...
                    - (D_prof_par-D_prof) * BigR / BB2 * Bgrad_rho_star * (Bgrad_rho-Bgrad_rhon)    * xjac * tstep &
                    - (D_prof_par_imp-D_prof_imp) * BigR / BB2 * Bgrad_rho_star * (Bgrad_rhon)      * xjac * tstep &
                    ...
                    !- (D_prof_par-D_prof) * BigR / BB2 * Bgrad_rho_star * (Bgrad_rho)               * xjac * tstep &
                    ! The old diffusion scheme for the impurities
         ...
         rhs_ij_5_k =  &
                      - (D_prof_par-D_prof) * BigR / BB2 * Bgrad_rho_k_star * (Bgrad_rho-Bgrad_rhon)   * xjac * tstep &
                      - (D_prof_par_imp-D_prof_imp) * BigR / BB2 * Bgrad_rho_k_star * (Bgrad_rhon)     * xjac * tstep &
                      ...
                      - D_prof_imp * BigR  * (           v_p*(rn0_p) * eps_cyl**2 /BigR**2 )      * xjac * tstep &
                       ...
                       !- (D_prof_par-D_prof) * BigR / BB2 * Bgrad_rho_k_star * (Bgrad_rho)             * xjac * tstep &
...
!===================== Additional terms from ionization energy terms============
                    ...
                    - (GAMMA - 1.) * E_ion * (D_prof_par_imp-D_prof_imp) * BigR / BB2 * Bgrad_rho_star * (Bgrad_rhon) * xjac * tstep &
                    - (GAMMA - 1.) * E_ion * D_prof_imp * BigR  * (v_x*(rn0_x) + v_y*(rn0_y)                                &
                                                                                                 )       * xjac * tstep &
                    - (GAMMA - 1.) * E_ion_bg * (D_prof_par-D_prof) * BigR / BB2 * Bgrad_rho_star * (Bgrad_rho-Bgrad_rhon)   &
                                                                                                         * xjac * tstep &
...
!===================== Additional terms from ionization energy terms============
                    - (GAMMA - 1.) * E_ion * (D_prof_par_imp-D_prof_imp) * BigR / BB2 * Bgrad_rho_k_star * (Bgrad_rhon) * xjac * tstep &
                    - (GAMMA - 1.) * E_ion * D_prof_imp * BigR * (                                                            &
                                                              + v_p*(rn0_p) * eps_cyl**2 /BigR**2 )        * xjac * tstep &
                    - (GAMMA - 1.) * E_ion_bg * (D_prof_par-D_prof) * BigR / BB2 * Bgrad_rho_k_star * (Bgrad_rho-Bgrad_rhon)   &
                                                                                                           * xjac * tstep &
...
!###################################################################################################
             ...
             amat_51 = &
                       - (D_prof_par-D_prof) * BigR * BB2_psi/ BB2**2 * Bgrad_rho_star     * (Bgrad_rho-Bgrad_rhon) * xjac * theta * tstep &
                       + (D_prof_par-D_prof) * BigR / BB2             * Bgrad_rho_star_psi * (Bgrad_rho-Bgrad_rhon) * xjac * theta * tstep &
                       + (D_prof_par-D_prof) * BigR / BB2             * Bgrad_rho_star     * (Bgrad_rho_psi-Bgrad_rhon_psi) * xjac * theta * tstep &
                       - (D_prof_par_imp-D_prof_imp) * BigR * BB2_psi/ BB2**2 * Bgrad_rho_star     * (Bgrad_rhon)   * xjac * theta * tstep &
                       + (D_prof_par_imp-D_prof_imp) * BigR / BB2             * Bgrad_rho_star_psi * (Bgrad_rhon)   * xjac * theta * tstep &
                       + (D_prof_par_imp-D_prof_imp) * BigR / BB2             * Bgrad_rho_star     * (Bgrad_rhon_psi)       * xjac * theta * tstep &  
                       !Old diffusion scheme for impurities
                       !- (D_prof_par-D_prof) * BigR * BB2_psi/ BB2**2 *  Bgrad_rho_star     * (Bgrad_rho) * xjac * theta * tstep &
                       !+ (D_prof_par-D_prof) * BigR / BB2             * Bgrad_rho_star_psi * (Bgrad_rho) * xjac * theta * tstep &
                       !+ (D_prof_par-D_prof) * BigR / BB2             * Bgrad_rho_star     * (Bgrad_rho_psi) * xjac * theta * tstep &
             ...
             amat_51_k = &
                         - (D_prof_par-D_prof) * BigR * BB2_psi/ BB2**2 * Bgrad_rho_k_star * (Bgrad_rho-Bgrad_rhon)         * xjac * theta * tstep &
                         + (D_prof_par-D_prof) * BigR / BB2             * Bgrad_rho_k_star * (Bgrad_rho_psi-Bgrad_rhon_psi) * xjac * theta * tstep &
                         - (D_prof_par_imp-D_prof_imp) * BigR * BB2_psi/ BB2**2 * Bgrad_rho_k_star * (Bgrad_rhon)           * xjac * theta * tstep &
                         + (D_prof_par_imp-D_prof_imp) * BigR / BB2             * Bgrad_rho_k_star * (Bgrad_rhon_psi)       * xjac * theta * tstep &
                         !- (D_prof_par-D_prof) * BigR * BB2_psi/ BB2**2 * Bgrad_rho_k_star * (Bgrad_rho)         * xjac * theta * tstep &
                         !+ (D_prof_par-D_prof) * BigR / BB2             * Bgrad_rho_k_star * (Bgrad_rho_psi) * xjac * theta * tstep &
             ...
             amat_55 = v * rho * BigR * (1.d0 + zeta)                                              * xjac   &
                     ...
                     + (D_prof_par-D_prof) * BigR / BB2 * Bgrad_rho_star * Bgrad_rho_rho                * xjac * theta * tstep &
             ...
             amat_55_k = + (D_prof_par-D_prof) * BigR / BB2 * Bgrad_rho_k_star * Bgrad_rho_rho          * xjac * theta * tstep &
                        
                    + TG_num5 * 0.25d0 / BigR * vpar0**2                                                        &
                               * (rho_x * ps0_y - rho_y * ps0_x                  )                              &
                               * (                              + F0 / BigR * v_p) * xjac * theta * tstep * tstep

             amat_55_n = + (D_prof_par-D_prof) * BigR / BB2 * Bgrad_rho_star   * Bgrad_rho_rho_n        * xjac * theta * tstep &
             ...
             amat_55_kn = + (D_prof_par-D_prof) * BigR / BB2 * Bgrad_rho_k_star * Bgrad_rho_rho_n       * xjac * theta * tstep &
             ...
             amat_58   = &
                         ...
                         - (D_prof_par-D_prof) * BigR / BB2 * Bgrad_rho_star * Bgrad_rho_rhon           * xjac * theta * tstep &
                         + (D_prof_par_imp-D_prof_imp) * BigR / BB2 * Bgrad_rho_star * Bgrad_rho_rhon   * xjac * theta * tstep &
                         - D_prof * BigR  * (v_x*rhon_x + v_y*rhon_y )                             * xjac * theta * tstep &
                         + D_prof_imp * BigR  * (v_x*rhon_x + v_y*rhon_y )                         * xjac * theta * tstep

             amat_58_k  = - (D_prof_par-D_prof) * BigR / BB2 * Bgrad_rho_k_star * Bgrad_rho_rhon       * xjac * theta * tstep &
                          + (D_prof_par_imp-D_prof_imp) * BigR / BB2 * Bgrad_rho_k_star * Bgrad_rho_rhon * xjac * theta * tstep

             amat_58_n  = - (D_prof_par-D_prof) * BigR / BB2 * Bgrad_rho_star   * Bgrad_rho_rhon_n     * xjac * theta * tstep &
                          + (D_prof_par_imp-D_prof_imp) * BigR / BB2 * Bgrad_rho_star * Bgrad_rho_rhon_n * xjac * theta * tstep

             amat_58_kn = &
                          + Dn0p * rhon_p * v_p*eps_cyl**2/BigR * xjac * theta * tstep &
                          - (D_prof_par-D_prof) * BigR / BB2 * Bgrad_rho_k_star * Bgrad_rho_rhon_n       * xjac * theta * tstep &
                          + (D_prof_par_imp-D_prof_imp) * BigR / BB2 * Bgrad_rho_k_star * Bgrad_rho_rhon_n * xjac * theta * tstep &
...
!=============== The ionization potential energy term=========================
                       ...
                       + (GAMMA-1.) * v * E_ion_bg * (r0-rn0) * (vpar0_s * psi_t - vpar0_t * psi_s)         * theta * tstep &
                          ...
                          ! New diffusive flux of the ionization potential energy for impurities
                       - (GAMMA - 1.) * E_ion * (D_prof_par_imp-D_prof_imp) * BigR * BB2_psi / BB2**2 * Bgrad_rho_star * (Bgrad_rhon) * xjac * theta * tstep &
                       + (GAMMA - 1.) * E_ion * (D_prof_par_imp-D_prof_imp) * BigR / BB2          * Bgrad_rho_star_psi * (Bgrad_rhon) * xjac * theta * tstep &
                       + (GAMMA - 1.) * E_ion * (D_prof_par_imp-D_prof_imp) * BigR / BB2          * Bgrad_rho_star * (Bgrad_rhon_psi) * xjac * theta * tstep &
                       - (GAMMA - 1.) * E_ion_bg * (D_prof_par-D_prof) * BigR * BB2_psi / BB2**2 * Bgrad_rho_star * (Bgrad_rho-Bgrad_rhon)         * xjac * theta * tstep &
                       + (GAMMA - 1.) * E_ion_bg * (D_prof_par-D_prof) * BigR / BB2              * Bgrad_rho_star_psi * (Bgrad_rho-Bgrad_rhon)     * xjac * theta * tstep &
                       + (GAMMA - 1.) * E_ion_bg * (D_prof_par-D_prof) * BigR / BB2              * Bgrad_rho_star * (Bgrad_rho_psi-Bgrad_rhon_psi) * xjac * theta * tstep &
...
!=============== The ionization potential energy term=========================
                       ! New diffusive flux of the ionization potential energy for impurities
                         - (GAMMA - 1.) * E_ion * (D_prof_par_imp-D_prof_imp) * BigR * BB2_psi / BB2**2 * Bgrad_rho_k_star * (Bgrad_rhon) * xjac * theta * tstep &
                         + (GAMMA - 1.) * E_ion * (D_prof_par_imp-D_prof_imp) * BigR / BB2          * Bgrad_rho_k_star * (Bgrad_rhon_psi) * xjac * theta * tstep &
                         - (GAMMA - 1.) * E_ion_bg * (D_prof_par-D_prof) * BigR * BB2_psi / BB2**2 * Bgrad_rho_k_star * (Bgrad_rho-Bgrad_rhon)         * xjac * theta * tstep &
                         + (GAMMA - 1.) * E_ion_bg * (D_prof_par-D_prof) * BigR / BB2              * Bgrad_rho_k_star * (Bgrad_rho_psi-Bgrad_rhon_psi) * xjac * theta * tstep &
!================= End ionization potential energy ===========================
                         + TG_num9 * 0.25d0 / BigR * vpar0**2                                                       &
                                   * Te0 * ((r0_x+alpha_e*rn0_x) * psi_y - (r0_y+alpha_e*rn0_y) * psi_x)            &
                                   * (                            + F0 / BigR * v_p) * xjac * theta * tstep * tstep &
...
!=============== The ionization potential energy term=========================
                    ...
                    ! New diffusive ionization energy flux term
                       + (GAMMA - 1.) * E_ion_bg * (D_prof_par-D_prof) * BigR / BB2 * Bgrad_rho_star * Bgrad_rho_rho                * xjac * theta * tstep &
...
!=============== The ionization potential energy term=========================
                    ...
                    ! New diffusive ionization energy flux term
                       + (GAMMA - 1.) * E_ion_bg * (D_prof_par-D_prof) * BigR / BB2 * Bgrad_rho_star * Bgrad_rho_rho_n * xjac * theta * tstep &
!================= End ionization potential energy =========================== 
...
!=============== The ionization potential energy term=========================
                    ! New diffusive ionization energy flux term
                       + (GAMMA - 1.) * E_ion_bg * (D_prof_par-D_prof) * BigR / BB2 * Bgrad_rho_k_star * Bgrad_rho_rho * xjac * theta * tstep &
...
!=============== The ionization potential energy term=========================
                    ! New diffusive ionization energy flux term
                    + (GAMMA - 1.) * E_ion_bg * (D_prof_par-D_prof) * BigR / BB2 * Bgrad_rho_k_star * Bgrad_rho_rho_n            * xjac * theta * tstep &
...
!=============== The ionization potential energy term=========================
                       ...
                       ! New diffusive ionization energy flux term
                       + (GAMMA - 1.) * E_ion * (D_prof_par_imp-D_prof_imp) * BigR / BB2 * Bgrad_rho_star * Bgrad_rho_rhon                  * xjac * theta * tstep &
                       + (GAMMA - 1.) * E_ion * D_prof_imp * BigR  * (v_x*rhon_x + v_y*rhon_y                                    ) * xjac * theta * tstep &
                       - (GAMMA - 1.) * E_ion_bg * (D_prof_par-D_prof) * BigR / BB2 * Bgrad_rho_star * Bgrad_rho_rhon                  * xjac * theta * tstep &
...
!=============== The ionization potential energy term=========================
                       ! New diffusive ionization energy flux term
                       + (GAMMA - 1.) * E_ion * (D_prof_par_imp-D_prof_imp) * BigR / BB2 * Bgrad_rho_k_star * Bgrad_rho_rhon                * xjac * theta * tstep &
                       - (GAMMA - 1.) * E_ion_bg * (D_prof_par-D_prof) * BigR / BB2 * Bgrad_rho_k_star * Bgrad_rho_rhon             * xjac * theta * tstep &
!================= End ionization potential energy ===========================
                       + TG_num9 * 0.25d0 / BigR * vpar0**2 &
                          * Te0 * alpha_e * (rhon_x * ps0_y - rhon_y * ps0_x                     )           &
                          * (                            + F0 / BigR * v_p) * xjac * theta * tstep * tstep   &
...
!=============== The ionization potential energy term=========================
                       ...
                       ! New diffusive ionization energy flux term
                       + (GAMMA - 1.) * E_ion * (D_prof_par_imp-D_prof_imp) * BigR / BB2 * Bgrad_rho_star * Bgrad_rho_rhon_n                * xjac * theta * tstep &
                       - (GAMMA - 1.) * E_ion_bg * (D_prof_par-D_prof) * BigR / BB2 * Bgrad_rho_star * Bgrad_rho_rhon_n             * xjac * theta * tstep &
!================= End ionization potential energy ===========================
...
!=============== The ionization potential energy term=========================
                       ! New diffusive ionization energy flux term
                       + (GAMMA - 1.) * E_ion * (D_prof_par_imp-D_prof_imp) * BigR / BB2 * Bgrad_rho_k_star * Bgrad_rho_rhon_n              * xjac * theta * tstep &
                       + (GAMMA - 1.) * E_ion * D_prof_imp * BigR  * (                        + v_p*rhon_p * eps_cyl**2 /BigR**2 ) * xjac * theta * tstep &
                       - (GAMMA - 1.) * E_ion_bg * (D_prof_par-D_prof) * BigR / BB2 * Bgrad_rho_k_star * Bgrad_rho_rhon_n              * xjac * theta * tstep &
...
!=============== The ionization potential energy term=========================
                       ...
                       ! New diffusive ionization energy flux term
                       + (GAMMA - 1.) * dE_ion_dT * Te * (D_prof_par_imp-D_prof_imp) * BigR / BB2 * Bgrad_rho_star * (Bgrad_rhon)                       * xjac * tstep &
...
!=============== The ionization potential energy term=========================
                       ! New diffusive ionization energy flux term
                       + (GAMMA - 1.) * dE_ion_dT * Te * (D_prof_par_imp-D_prof_imp) * BigR / BB2 * Bgrad_rho_k_star * (Bgrad_rhon)                     * xjac * tstep &
