...
contains
  ...
  subroutine boundary_conditions( my_id, node_list, element_list, bnd_node_list, local_elms,& 
    ...
    real*8  :: T0, Vpar0, bigR, dT0_ds, dVpar0_ds, dBigR_ds
    ...
    integer :: i_bnd, ife, inode1, inode2, knode, j, l, index_ij, index_kl
    integer :: index_i, index_large_k, index_node1, index_node2, i_order, k_order, ic
    integer :: ijA_position2, nz_AA2, n_AA2, ilarge2, kv, kT, ku, ilarge_vv, ilarge_vT, ilarge_vus
