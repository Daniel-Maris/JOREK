...
module parameters
  ...
  integer, parameter :: n_tor          = 3!21!21!3!21         !< number of toroidal harmonics
  integer, parameter :: n_period       = 20!2!2!20!2         !< periodicity in toroidal direction
  integer, parameter :: n_plane        = 32!128!64!64!128         !< number of toroidal angles
