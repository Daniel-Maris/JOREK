...
!-----------------------------------------------------------------------
  ...
  if ( num_rho ) then
    write(*,*) 'Using numerical rho profile from file "'//trim(rho_file)//'"'
  ...
  num_T = ( T_file /= 'none' )
  if ( num_T ) then
    write(*,*) 'Using numerical T profile from file "'//trim(T_file)//'"'
  ...
  if ( num_ffprime ) then
    write(*,*) 'Using numerical ffprime profile from file "'//trim(ffprime_file)//'"'
