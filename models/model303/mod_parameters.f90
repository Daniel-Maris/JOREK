...
module mod_parameters
  ...
  integer, parameter :: n_order        = 5         !< order of the polynomial basis
  integer, parameter :: n_tor          = 3!9         !< number of toroidal harmonicsin physics variables
  ...
  integer, parameter :: n_plane        = 4!32        !< number of toroidal angles
