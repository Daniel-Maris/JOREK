...
!DEC$ ATTRIBUTES FORCEINLINE :: ELM_main_rhs_6_numm
  ...
  ! --- The RHS term (Taylor Galerkin (TG2) stabilisation)	      
  rhs(6)   = rhs(6)											&
             - TG_num6 * tstep * 0.25d0 * BigR**3 * T0  * (r0_x * u0_y  - r0_y  * u0_x)			&
                                                        * (v_x  * u0_y  - v_y   * u0_x)	* xjac * tstep	&
             - TG_num6 * tstep * 0.25d0 * BigR**3 * r0  * (T0_x * u0_y  - T0_y  * u0_x)			&
                                                        * (v_x  * u0_y  - v_y   * u0_x)	* xjac * tstep	&
             - TG_num6 * tstep * 0.25d0 / BigR * vpar0**2 * T0						&
                       * (r0_x  * ps0_y - r0_y  * ps0_x + F0 / BigR * r0_p)				&
                       * (v_x   * ps0_y - v_y   * ps0_x)				* xjac * tstep	&
             - TG_num6 * tstep * 0.25d0 / BigR * vpar0**2 * r0						&
                       * (T0_x  * ps0_y - T0_y * ps0_x + F0 / BigR * T0_p)				&
                       * (v_x   * ps0_y - v_y  * ps0_x)					* xjac * tstep
...
!DEC$ ATTRIBUTES FORCEINLINE :: ELM_main_lhs_6_numm
  ...
  amat(6,2)    = amat(6,2)													&
                 + TG_num6 * tstep * 0.25d0 * BigR**2 * T0  * (r0_x  * u_y  - r0_y  * u_x)					&
        	                                            * ( v_x  * u0_y - v_y   * u0_x)		* xjac * theta * tstep	&
                 + TG_num6 * tstep * 0.25d0 * BigR**2 * r0  * (T0_x  * u_y  - T0_y  * u_x)					&
        	                                            * ( v_x  * u0_y - v_y   * u0_x)		* xjac * theta * tstep	&
                 + TG_num6 * tstep * 0.25d0 * BigR**2 * T0  * (r0_x  * u0_y - r0_y  * u0_x)					&
        	                                            * ( v_x  * u_y  - v_y   * u_x)		* xjac * theta * tstep	&
                 + TG_num6 * tstep * 0.25d0 * BigR**2 * r0  * (T0_x  * u0_y - T0_y  * u0_x)					&
        	                                            * ( v_x  * u_y  - v_y   * u_x)		* xjac * theta * tstep

  amat(6,5)    = amat(6,5)													&
             	 + TG_num6 * tstep * 0.25d0 * BigR**2 * T0  * (rho_x * u0_y - rho_y * u0_x)					&
             		                                    * ( v_x  * u0_y - v_y   * u0_x)		* xjac * theta * tstep	&
             	 + TG_num6 * tstep * 0.25d0 * BigR**2 * rho * (T0_x  * u0_y - T0_y  * u0_x)					&
             		                                    * ( v_x  * u0_y - v_y   * u0_x)		* xjac * theta * tstep	&
             	 + TG_num6 * tstep * 0.25d0 / BigR * vpar0**2 * T0								&
  ...
  amat(6,6)    = amat(6,6)													&
             	 + TG_num6 * tstep * 0.25d0 * BigR**2 * T  * (r0_x * u0_y - r0_y * u0_x)					&
             		                                   * (v_x  * u0_y - v_y  * u0_x)		* xjac * theta * tstep	&
             	 + TG_num6 * tstep * 0.25d0 * BigR**2 * r0 * (T_x  * u0_y - T_y  * u0_x)					&
             		                                   * (v_x  * u0_y - v_y  * u0_x)		* xjac * theta * tstep	&		 
             	 + TG_num6 * tstep * 0.25d0 / BigR * vpar0**2 * T								&
             		   * (r0_x * ps0_y - r0_y * ps0_x + F0 / BigR * r0_p)							&
             		   * ( v_x * ps0_y -  v_y * ps0_x )						* xjac * theta * tstep	&
             	 + TG_num6 * tstep * 0.25d0 / BigR * vpar0**2 * r0								&
             		   * (T_x * ps0_y - T_y * ps0_x )									&
  ...
  amat(6,7)    = amat(6,7)													&
             	 + TG_num6 * tstep * 0.25d0 / BigR * 2.d0 * vpar0 * vpar * T0							&
             		   * (r0_x * ps0_y - r0_y * ps0_x + F0 / BigR * r0_p)							&
             		   * ( v_x * ps0_y -  v_y * ps0_x )						* xjac * theta * tstep	&
