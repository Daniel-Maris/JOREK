...
module mod_parameters
  ...
  integer, parameter :: var_r  = 7!!!TO BE REMOVED!!!    ! place of variable density     (r)
  ...
  integer, parameter :: n_tor          = 3!3         !< number of toroidal harmonics
  integer, parameter :: n_period       = 30!1         !< periodicity in toroidal direction
  integer, parameter :: n_plane        = 8!4         !< number of toroidal angles
