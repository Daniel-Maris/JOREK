...
subroutine preset_parameters
  ...
  gamma_sheath_i     = 4.5d0  ! sheath transmission factor (single fluid) in the JOREK definition
  gamma_sheath_e     = 4.5d0  ! sheath transmission factor (single fluid) in the JOREK definition
