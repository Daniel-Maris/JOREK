...
module mod_parameters
  ...
  integer, parameter :: jorek_model    = 555		!< JOREK physics model
  ...
  integer, parameter :: var_rn   = 8                       ! place of variable neutral or impurity density (rn)
  ...
  character(len=11) :: variable_names(n_var) =                       &
    (/ 'Flux       ','Potential  ','Current    ','Vorticity  ',      &
       'Density    ','Ions_Temp  ','V_parallel ','N_density  '/)
