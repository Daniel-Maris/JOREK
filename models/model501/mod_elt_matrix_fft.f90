...
real*8     :: D_prof, D_prof_par, ZK_prof, psi_norm, theta, zeta, delta_u_x, delta_u_y, delta_ps_x, delta_ps_y
...
!=============== The ionization potential energy term=========================
                       ...
                       ! New diffusive ionization energy flux term
                       + (GAMMA - 1.) * dE_ion_dT * T * (D_prof_par_imp-D_prof_imp) * BigR / BB2 * Bgrad_rho_star * (Bgrad_rhon)                       * xjac * tstep &
...
!=============== The ionization potential energy term=========================
                       ! New diffusive ionization energy flux term
                       + (GAMMA - 1.) * dE_ion_dT * T * (D_prof_par_imp-D_prof_imp) * BigR / BB2 * Bgrad_rho_k_star * (Bgrad_rhon)                     * xjac * tstep &
