...
real*8     :: ZK_prof, D_prof, D_prof_par, psi_norm, theta, zeta, delta_u_x, delta_u_y, delta_ps_x, delta_ps_y, ZKpar_T, dZKpar_dT
...
!###################################################################################################
                 ...
                 amat_51 = &!- (D_prof_par-D_prof) * BigR * BB2_psi / BB2**2 * Bgrad_rho_star * (Bgrad_rho)                     * xjac * theta * tstep &
