...
do ms=1, n_gauss
 ...
 do mt=1, n_gauss
   ...
   do mp = 1, n_plane
     ...
     T0_corr = corr_neg_temp(T0,(/5.d-1,5.d-1/)) ! For use in eta(T), visco(T), ...
     dT0_corr_dT = dcorr_neg_temp_dT(T0,(/5.d-1,5.d-1/)) ! Improve the correction
     d2T0_corr_dT2 = d2corr_neg_temp_dT2(T0,(/5.d-1,5.d-1/))
...
!=============== The ionization potential energy term=========================
                           ...
                           - (2./3.) * v * E_ion_bg * rho * 2.d0 * BigR * u0_y         * xjac * theta * tstep &
                           + (2./3.) * v * E_ion_bg * rho * (vpar0_s*ps0_t - vpar0_t*ps0_s)   * theta * tstep &
