...
module phys_module
  ...
  logical :: modify_meshac     !< Generate the flux-aligned grid with modified meshac for SIG_closed, SIG_open, and SIG_theta
  ...
  real*8  :: xr_closed(2)      !< Location for grid accumulation (for flux-aligned grid)
