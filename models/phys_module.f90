...
module phys_module
  ...
  real*8  :: loop_voltage         !< artificially ramp up or down the  plasma current (in V)
  real*8  :: loop_voltage_control !< modify the slope of the Ip variation given by the loop voltage (in V)
