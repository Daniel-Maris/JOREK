...
module phys_module
  ...
  real*8  :: loop_voltage         !< use to ramp up or down the  plasma current (in V)
  real*8  :: loop_voltage_control !< use to modify the slope of the Ip variation given by the loop voltage (in V)
