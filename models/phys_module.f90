...
module phys_module
  ...
  type :: type_part_group_config
    ...
    character           :: kin_bg_coll_type        !< choose type of heat flux used in collisions, either Homma2013 or Homma2020 at the moment
    real*8              :: homma2020_alpha         !< alpha factor in Homma2020 heat flux to limit, recommended value is 1.5, See Homma 2020 and Fundamenski 2005
