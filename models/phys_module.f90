...
module phys_module
  ...
  real*8  :: T_min_ZKpar          !< Do not use smaller parallel heat diffusion values below this total temperature (Ti+Te) 
  real*8  :: Ti_min_ZKpar         !< Do not use smaller parallel heat diffusion values below Ti
  real*8  :: Te_min_ZKpar         !< Do not use smaller parallel heat diffusion values below Te
