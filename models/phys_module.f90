...
module phys_module
  ...
  logical :: fix_axis_nodes       !< Fix t-derivative on axis to avoid noise)
  ...
  logical :: static_run           !< Perform a static run where the momentum quantities (VR,VZ,Vp or U,W,Vpar) do not change with time?
