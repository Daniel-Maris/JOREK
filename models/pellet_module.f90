...
real*8 :: total_pellet_particles = 1.   !< the (total) pellet particles added in this timestep
real*8 :: total_plasma_particles = 1.   !< the total plasma density (before this timestep)
real*8 :: total_pellet_volume    = 1.   !< the volume of the simulated pellet in this timestep
