...
!DEC$ ATTRIBUTES FORCEINLINE :: ELM_main_lhs_2
  ...
  amat(2,7)   = + amu_neo_prof * BB2 / (Btheta2+epsil) * r0 * vpar * (ps0_x*v_x + ps0_y*v_y) * BigR		* xjac * tstep * theta 
...
!DEC$ ATTRIBUTES FORCEINLINE :: ELM_main_lhs_5
  ...
  amat(5,8)    = - tau_IC * v * 2.d0 * (Te_y*r0 + Te*r0_y) * BigR				* xjac * theta * tstep 
...
!DEC$ ATTRIBUTES FORCEINLINE :: ELM_main_lhs_7
  ...
  amat(7,2)   = - v * amu_neo_prof * BB2 / (Btheta2+epsil) * r0 * (ps0_x*u_x + ps0_y*u_y) * BigR		* xjac * theta * tstep 
