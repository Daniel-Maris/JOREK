...
module parameters
  ...
  integer, parameter :: n_tor          = 3!21         !< number of toroidal harmonics
  integer, parameter :: n_period       = 1!2         !< periodicity in toroidal direction
  integer, parameter :: n_plane        = 16!128         !< number of toroidal angles
