...
module parameters
  ...
  integer, parameter :: n_tor          = 3!1!21         !< number of toroidal harmonics
  integer, parameter :: n_period       = 3!1!2         !< periodicity in toroidal direction
  integer, parameter :: n_plane        = 8!1!128         !< number of toroidal angles
