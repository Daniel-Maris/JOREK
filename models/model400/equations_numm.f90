...
!DEC$ ATTRIBUTES FORCEINLINE :: ELM_main_rhs_6_numm
  ...
  ! --- The RHS term (Taylor Galerkin (TG2) stabilisation)	      
  rhs(6)   = rhs(6)											&
             - TG_num6 * tstep * 0.25d0 * R**3 * Ti0 * (r0_x * u0_y  - r0_y  * u0_x)			&
                                                     * (v_x  * u0_y  - v_y   * u0_x)	* xjac * tstep	&
             - TG_num6 * tstep * 0.25d0 * R**3 * r0  * (Ti0_x * u0_y - Ti0_y * u0_x)			&
                                                     * (v_x   * u0_y - v_y   * u0_x)	* xjac * tstep	&
             - TG_num6 * tstep * 0.25d0 / R * vpar0**2 * Ti0						&
                       * (r0_x  * ps0_y - r0_y  * ps0_x + F0 / R * r0_p)				&
                       * (v_x   * ps0_y - v_y   * ps0_x)				* xjac * tstep	&
             - TG_num6 * tstep * 0.25d0 / R * vpar0**2 * r0						&
                       * (Ti0_x * ps0_y - Ti0_y * ps0_x + F0 / R * Ti0_p)				&
                       * (v_x   * ps0_y - v_y   * ps0_x)				* xjac * tstep
...
!DEC$ ATTRIBUTES FORCEINLINE :: ELM_main_lhs_6_numm
  ...
  amat(6,2)    = amat(6,2)													&
                 + TG_num6 * tstep * 0.25d0 * R**2 * Ti0 * (r0_x  * u_y  - r0_y  * u_x)						&
        	                                         * ( v_x  * u0_y - v_y   * u0_x)		* xjac * theta * tstep	&
                 + TG_num6 * tstep * 0.25d0 * R**2 * r0  * (Ti0_x * u_y  - Ti0_y * u_x)						&
        	                                         * ( v_x  * u0_y - v_y   * u0_x)		* xjac * theta * tstep	&
                 + TG_num6 * tstep * 0.25d0 * R**2 * Ti0 * (r0_x  * u0_y - r0_y  * u0_x)					&
        	                                         * ( v_x  * u_y  - v_y   * u_x)			* xjac * theta * tstep	&
                 + TG_num6 * tstep * 0.25d0 * R**2 * r0  * (Ti0_x * u0_y - Ti0_y * u0_x)					&
        	                                         * ( v_x  * u_y  - v_y   * u_x)			* xjac * theta * tstep

  amat(6,5)    = amat(6,5)													&
             	 + TG_num6 * tstep * 0.25d0 * R**2 * Ti0 * (rho_x * u0_y - rho_y * u0_x)					&
             		                                    * ( v_x * u0_y  - v_y   * u0_x)		* xjac * theta * tstep	&
             	 + TG_num6 * tstep * 0.25d0 * R**2 * rho * (Ti0_x * u0_y - Ti0_y * u0_x)					&
             		                                    * ( v_x * u0_y  - v_y   * u0_x)		* xjac * theta * tstep	&
             	 + TG_num6 * tstep * 0.25d0 / R * vpar0**2 * Ti0								&
  ...
  amat(6,6)    = amat(6,6)													&
             	 + TG_num6 * tstep * 0.25d0 * R**2 * Ti * (r0_x * u0_y - r0_y * u0_x)						&
             		                                * ( v_x * u0_y - v_y * u0_x)			* xjac * theta * tstep	&
             	 + TG_num6 * tstep * 0.25d0 * R**2 * r0 * (Ti_x * u0_y - Ti_y * u0_x)						&
             		                                * ( v_x * u0_y - v_y * u0_x)			* xjac * theta * tstep	&		 
             	 + TG_num6 * tstep * 0.25d0 / R * vpar0**2 * Ti									&
             		   * (r0_x * ps0_y - r0_y * ps0_x + F0 / R * r0_p)							&
             		   * ( v_x * ps0_y -  v_y * ps0_x )						* xjac * theta * tstep	&
             	 + TG_num6 * tstep * 0.25d0 / R * vpar0**2 * r0									&
  ...
  amat(6,7)    = amat(6,7)													&
             	 + TG_num6 * tstep * 0.25d0 / R * 2.d0 * vpar0 * vpar * Ti0							&
             		   * (r0_x * ps0_y - r0_y * ps0_x + F0 / R * r0_p)							&
             		   * ( v_x * ps0_y -  v_y * ps0_x )						* xjac * theta * tstep	&
...
!DEC$ ATTRIBUTES FORCEINLINE :: ELM_main_rhs_8_numm
  ...
  ! --- The RHS term (Taylor Galerkin (TG2) stabilisation)	      
  rhs(8)   = rhs(8)											&
             - TG_num8 * tstep * 0.25d0 * R**3 * Te0 * ( r0_x * u0_y -  r0_y * u0_x)			&
             	                                     * (  v_x * u0_y -   v_y * u0_x)	* xjac * tstep	&
             - TG_num8 * tstep * 0.25d0 * R**3 * r0  * (Te0_x * u0_y - Te0_y * u0_x)			&
             	                                     * (  v_x * u0_y -   v_y * u0_x)	* xjac * tstep	&
             - TG_num8 * tstep * 0.25d0 / R * vpar0**2 * Te0						&
             	       * (r0_x  * ps0_y - r0_y  * ps0_x + F0 / R * r0_p)				&
             	       * ( v_x  * ps0_y -  v_y  * ps0_x)				* xjac * tstep	&
             - TG_num8 * tstep * 0.25d0 / R * vpar0**2 * r0						&
            	       * (Te0_x * ps0_y - Te0_y * ps0_x + F0 / R * Te0_p)				&
             	       * (  v_x * ps0_y -   v_y * ps0_x)				* xjac * tstep 
...
!DEC$ ATTRIBUTES FORCEINLINE :: ELM_main_lhs_8_numm
  ...
  amat(8,2)    = amat(8,2)													&
                 + TG_num8 * tstep * 0.25d0 * R**2 * Te0 * ( r0_x * u_y  -  r0_y * u_x)						&
                     	                                 * (  v_x * u0_y -   v_y * u0_x)		* xjac * theta * tstep	&
                 + TG_num8 * tstep * 0.25d0 * R**2 * r0  * (Te0_x * u_y  - Te0_y * u_x)						&
                     	   * ( v_x * u0_y - v_y * u0_x)							* xjac * theta * tstep	&
                 + TG_num8 * tstep * 0.25d0 * R**2 * Te0 * ( r0_x * u0_y -  r0_y * u0_x)					&
                     	                                 * (  v_x * u_y  -   v_y * u_x)			* xjac * theta * tstep	&
                 + TG_num8 * tstep * 0.25d0 * R**2 * r0  * (Te0_x * u0_y - Te0_y * u0_x)					&
                     	                                 * (  v_x * u_y  -   v_y * u_x)			* xjac * theta * tstep
 	  	  	    
  amat(8,5)    = amat(8,5)													&
                 + TG_num8 * tstep * 0.25d0 * R**2 * Te0 * (rho_x * u0_y - rho_y * u0_x)					&
                     	                                    * ( v_x * u0_y - v_y * u0_x)		* xjac * theta * tstep	&
                 + TG_num8 * tstep * 0.25d0 * R**2 * rho * (Te0_x * u0_y - Te0_y * u0_x)					&
                     	                                    * ( v_x * u0_y - v_y * u0_x)		* xjac * theta * tstep	&
                 + TG_num8 * tstep * 0.25d0 / R * vpar0**2 * Te0								&
                 	   * (rho_x * ps0_y - rho_y * ps0_x + F0 / R * rho_p)							&
                 	   * ( v_x * ps0_y -  v_y * ps0_x )						* xjac * theta * tstep	&
                 + TG_num8 * tstep * 0.25d0 / R * vpar0**2 * rho								&
                 	   * (Te0_x * ps0_y - Te0_y * ps0_x + F0 / R * Te0_p)							&
                 	   * ( v_x * ps0_y -  v_y * ps0_x )						* xjac * theta * tstep  
  ...
  amat(8,7)    = amat(8,7)													&
                 + TG_num8 * tstep * 0.25d0 / R * 2.d0 * vpar0 * vpar * Te0							&
                 	   * (r0_x * ps0_y - r0_y * ps0_x + F0 / R * r0_p)							&
                 	   * ( v_x * ps0_y -  v_y * ps0_x )						* xjac * theta * tstep	&
                 + TG_num8 * tstep * 0.25d0 / R * 2.d0 * vpar0 * vpar * r0							&
                 	   * (Te0_x * ps0_y - Te0_y * ps0_x + F0 / R * Te0_p)							&
                 	   * ( v_x * ps0_y -  v_y * ps0_x )						* xjac * theta * tstep
  ...
  amat(8,8)    = amat(8,8)													&
                 + TG_num8 * tstep * 0.25d0 * R**2 * Te * (r0_x * u0_y - r0_y * u0_x)						&
                     	                                * ( v_x * u0_y - v_y * u0_x)			* xjac * theta * tstep	&
                 + TG_num8 * tstep * 0.25d0 * R**2 * r0 * (Te_x * u0_y - Te_y * u0_x)						&
                     	                                * ( v_x * u0_y - v_y * u0_x)			* xjac * theta * tstep	&
                 + TG_num8 * tstep * 0.25d0 / R * vpar0**2 * Te									&
                     	   * (r0_x * ps0_y - r0_y * ps0_x + F0 / R * r0_p)							&
                     	   * ( v_x * ps0_y -  v_y * ps0_x )						* xjac * theta * tstep	&
                 + TG_num8 * tstep * 0.25d0 / R * vpar0**2 * r0									&
