...
module equation_variables
  ...
  ! --- Variable 6
  real*8 	:: Ti0,   Ti0_x,   Ti0_y,   Ti0_p,   Ti0_s,   Ti0_t,   Ti0_ss,   Ti0_st,   Ti0_tt,   Ti0_xx,   Ti0_xy,   Ti0_yy,   Ti0_pp
  real*8 	:: Ti,    Ti_x,    Ti_y,    Ti_p,    Ti_s,    Ti_t,    Ti_ss,    Ti_st,    Ti_tt,    Ti_xx,    Ti_xy,    Ti_yy,    Ti_pp
  ! --- Variable 7
  ...
  !$omp 	tau_IC, r0min, Wdia, 													   &
  !$omp 	epsil, Btheta2, 													   &
  !$omp 	amu_neo_prof, aki_neo_prof, 												   &
  !$omp 	jb, jb_switch, small_r, B_theta, theta_pol,										   &
  ...
  !$omp 	Ti0,   Ti0_x,	Ti0_y,   Ti0_p,   Ti0_s,   Ti0_t,   Ti0_ss,   Ti0_st,	Ti0_tt,   Ti0_xx,   Ti0_xy,   Ti0_yy,	Ti0_pp,    &
  !$omp 	Ti,    Ti_x,	Ti_y,	 Ti_p,    Ti_s,    Ti_t,    Ti_ss,    Ti_st,	Ti_tt,    Ti_xx,    Ti_xy,    Ti_yy,	Ti_pp,	   &
