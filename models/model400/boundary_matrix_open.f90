...
real*8     :: rhs_ij_5, rhs_ij_6, rhs_ij_8
...
real*8     :: amat_61, amat_65, amat_66, amat_67, amat_68
real*8     :: amat_81, amat_85, amat_86, amat_87, amat_88
     ...
     do i=1,2                ! loop over nodes
       ...
       do j=1,2              ! loop over basis functions
         ...
         do im=1,n_tor
           ...
           rhs_ij_6 = - v * (gamma_sheath_i -1.d0) * r0 * (Ti0 + Te0) * vpar0 * ps0_s * tstep     ! right hand side equation 6

           rhs_ij_8 = - v * (gamma_sheath_e -1.d0) * r0 * (Ti0 + Te0) * vpar0 * ps0_s * tstep     ! right hand side equation 6
           ...
           do k=1,2                                                          ! loop over nodes
             ...
             do l=1,2                                                        ! loop over basis functions
               ...
               do in = 1, n_tor                                              ! loop over toroidal harmonics
                 ...
                 amat_61 = + v * (gamma_sheath_i-1.d0) * r0  * (Ti0 + Te0) * vpar0 * psi_s * theta * tstep 
                 amat_65 = + v * (gamma_sheath_i-1.d0) * rho * (Ti0 + Te0) * vpar0 * ps0_s * theta * tstep 
                 amat_66 = + v * (gamma_sheath_i-1.d0) * r0  * Ti          * vpar0 * ps0_s * theta * tstep 
                 amat_67 = + v * (gamma_sheath_i-1.d0) * r0  * (Ti0 + Te0) * vpar  * ps0_s * theta * tstep 
                 amat_68 = + v * (gamma_sheath_i-1.d0) * r0  * Te          * vpar0 * ps0_s * theta * tstep 

                 amat_81 = + v * (gamma_sheath_e-1.d0) * r0  * (Ti0 + Te0) * vpar0 * psi_s * theta * tstep 
                 amat_85 = + v * (gamma_sheath_e-1.d0) * rho * (Ti0 + Te0) * vpar0 * ps0_s * theta * tstep 
                 amat_86 = + v * (gamma_sheath_e-1.d0) * r0  * Ti          * vpar0 * ps0_s * theta * tstep 
                 amat_87 = + v * (gamma_sheath_e-1.d0) * r0  * (Ti0 + Te0) * vpar  * ps0_s * theta * tstep 
                 amat_88 = + v * (gamma_sheath_e-1.d0) * r0  * Te          * vpar0 * ps0_s * theta * tstep 
                 ...
                 ELM(ij6,kl8) =  ELM(ij6,kl8) + ws * amat_68
