...
real*8     :: sigmas(21), dZ_axis, dR_axis, Z_axis_int, Z_axis_old, R_axis_old, R_axis_int, area_ref
integer    :: n_grids(12)
...
if (my_id == 0) then
  ...
  if (xpoint2 .and. (n_flux .gt. 1)) then
    ...
    call define_flux_values(node_list, element_list, surface_list, sep_list, xcase2, psi_xpoint, n_grids, sigmas, modify_meshac)
