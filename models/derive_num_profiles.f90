...
subroutine derive_num_profiles(my_id)
  ...
  if ( my_id == 0 ) then
    ...
    if ( num_rho ) then
      ...
      call derivProf(num_rho_x, num_rho_y3, num_rho_len, num_rho_y4)
      call derivProf(num_rho_x, num_rho_y4, num_rho_len, num_rho_y5)
    end if

    if ( num_rhon ) then
      call derivProf(num_rhon_x, num_rhon_y0, num_rhon_len, num_rhon_y1)
      call derivProf(num_rhon_x, num_rhon_y1, num_rhon_len, num_rhon_y2)
      call derivProf(num_rhon_x, num_rhon_y2, num_rhon_len, num_rhon_y3)
      call derivProf(num_rhon_x, num_rhon_y3, num_rhon_len, num_rhon_y4)
    end if
    ...
    if ( num_T ) then
      ...
      call derivProf(num_T_x, num_T_y3, num_T_len, num_T_y4)
      call derivProf(num_T_x, num_T_y4, num_T_len, num_T_y5)
    end if
    ...
    if ( num_Ti ) then
      ...
      call derivProf(num_Ti_x, num_Ti_y3, num_Ti_len, num_Ti_y4)
      call derivProf(num_Ti_x, num_Ti_y4, num_Ti_len, num_Ti_y5)
    end if
    ...
    if ( num_Te ) then
      ...
      call derivProf(num_Te_x, num_Te_y3, num_Te_len, num_Te_y4)
      call derivProf(num_Te_x, num_Te_y4, num_Te_len, num_Te_y5)
    end if
    ...
    if ( num_rot ) then
      ...
      call derivProf(num_rot_x, num_rot_y3, num_rot_len, num_rot_y4)
    end if    
