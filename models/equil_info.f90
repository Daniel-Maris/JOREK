...
module equil_info
  ...
  use phys_module,        only: i_plane_rtree, n_plane, n_period, R_geo, Z_geo, FF_0, psi_axis_t, psi_bnd_t, Z_xpoint_t, index_now, SDN_threshold, tokamak_device, Z_xpoint_limit
  use mod_interp
