...
!---------------------------------------------- plot equilibrium current profile (to be removed)
      ...
      do i=1,nplot
        ...
        if (ifail .eq. 0) then
    	  ...
    	  call density(xpoint,xcase, Zp, ES%Z_xpoint, psi,ES%psi_axis,ES%psi_bnd,zn,       &
    	  ...
    	  if (with_TiTe) then	     
    	    call temperature_i(xpoint,xcase, Zp, ES%Z_xpoint, psi,ES%psi_axis,ES%psi_bnd, zTi, &
    	    ...
    	    call temperature_e(xpoint,xcase, Zp, ES%Z_xpoint, psi,ES%psi_axis,ES%psi_bnd, zTe, &
            ...
            call temperature(xpoint,xcase, Zp, ES%Z_xpoint, psi,ES%psi_axis,ES%psi_bnd, zT, &
    	  ...
    	  call FFprime(    xpoint,xcase, Zp, ES%Z_xpoint, psi,ES%psi_axis,ES%psi_bnd, zFFprime,       &
