subroutine get_vacuum_response(my_id, node_list, boundary_list, bnd_node_list)
!-------------------------------------------------------------------
...
!-------------------------------------------------------------------
  ...
  230 format(A,' = ',I8)
  231 format(A,' = ',L8)
  write(*,230) 'n_bnd_elements',boundary_list%n_bnd_elements
  ...
  if (my_id .eq. 0) call export_boundary(node_list, boundary_list, bnd_node_list)
