...
def generate_argument_parser():
  ...
  parser.add_argument('--first-file-name','-fn1',type=str,required=True,\
  action="store",dest="file1_name",help="Name of the first file")
  parser.add_argument('--second-file-name','-fn2',type=str,required=True,\
  action="store",dest="file2_name",help="Name of the second file")
  parser.add_argument('--dataset-name','-dn',type=str,required=True,\
  action="store",dest="dset_name",help="Name of the dataset to be compared")
