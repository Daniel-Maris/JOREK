...
function restart_run () {
  cp "${testcasedir}/ffprime_generated" "${tmpdir}/ffprime_generated"                 || exit 1
  cp "${testcasedir}/jorek_temperature_highres" "${tmpdir}/jorek_temperature_highres" || exit 1
  cp "${testcasedir}/jorek_density_highres" "${tmpdir}/jorek_density_highres"         || exit 1
