subroutine grid_upper_xpoint_wall(node_list, element_list, n_flux, n_open, n_up_priv, n_up_leg, n_up_leg_out, n_tht, n_ext,&
  SIG_open, SIG_closed, SIG_up_priv, SIG_theta_up, SIG_up_leg_0, SIG_up_leg_1, dPSI_open, dPSI_up_priv, modify_meshac)
!-----------------------------------------------------------------------
...
real*8,                   intent(in)    :: SIG_open, SIG_closed, SIG_up_priv, SIG_theta_up, SIG_up_leg_0, SIG_up_leg_1
