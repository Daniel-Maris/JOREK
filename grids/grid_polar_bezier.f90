...
use phys_module, only: psi_axis_init, XR_r, SIG_r, XR_tht, SIG_tht, bgf_r, bgf_tht, fix_axis_nodes, force_central_node, treat_axis, n_flux
...
call meshac2(nr,S2,XR_r(1),XR_r(2),SIG_r(1),SIG_r(2),bgf_r,1.0d0)
