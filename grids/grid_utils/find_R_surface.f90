subroutine find_R_surface(node_list,element_list,surface_list,j_surf,R_find,i_elm_find,s_find,t_find,st_find,i_find,quiet)
!---------------------------------------------------------------------------
...
if ( (i_find .eq. 0) .and. (printout) ) write(*,*) ' WARNING : no R surface found'
