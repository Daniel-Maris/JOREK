...
subroutine get_target_flux_surfaces(node_list, element_list, surface, psi_bnd, Z_xpoint, n_int, R_int, Z_int, index_surf, index_wall)
  ...
  real*8,                   intent(inout)	:: R_int(:), Z_int(:)
  real*8,                   intent(inout)	:: psi_bnd,   Z_xpoint(2)
  integer,                  intent(inout)	:: index_surf(:), index_wall(:)
  ...
  integer			:: n_int_tmp, index_surf_tmp(20), index_wall_tmp(20) ! Assume maximum 20 intersections 
  real*8			:: R_int_tmp(20), Z_int_tmp(20)
  
  ! --- First get all intersections with wall
  call find_wall_crossings_with_flux_surface(node_list, element_list, surface, n_int_tmp, R_int_tmp, Z_int_tmp, index_surf_tmp, index_wall_tmp)
...
subroutine find_wall_crossings_with_flux_surface(node_list, element_list, surface, n_int, R_int, Z_int, index_surf, index_wall)
  ...
  integer,                  intent(inout)	:: index_surf(20), index_wall(20)
